...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Suriya Singaravel's Resume",
    description: 'Fullstack Developer • AI Engineer',
    fileType: 'PDF',
    lastUpdated: 'September 2025',
    fileSize: '120 KB',
    previewImageSrc: '/resume_suriya_preview.png',
    downloadUrl: '/Suriya-Singaravel-Fullstack.pdf',
  };
      ...
      >
        ...
        <div className="p-5">
          <div className="flex items-center justify-between">
            ...
            {/* Download indicator */}
            <motion.div
              className="flex h-10 w-10 items-center justify-center rounded-full bg-black text-white group-hover:bg-black/80"
              initial={{ scale: 1 }}
            >
